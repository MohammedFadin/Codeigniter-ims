...
<table class="table">
    ...
    if(isset($obj->userdata['username']))
        ...
        echo'<div class="left"><a class="btn btn-mini" href="http://localhost/CodeIgniter/index.php/home">Go Home</a></div>';
    }else
        {?>
    <?php
     
    echo'<div class="left"><a class="btn btn-mini" href="http://localhost/CodeIgniter/index.php">Go Home</a></div>';
      } ?>
    <tr>
    	<th>Id</th>
    	<th>Username</th>
