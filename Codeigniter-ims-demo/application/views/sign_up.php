...
<div class="content">
    <div class="left"><a href="http://localhost/CodeIgniter/index.php/welcome"class="btn btn-large disabled">back</a></div>
    ...
    <?php echo form_open('welcome/signups'); ?>
        ...
        <div class="center">
            ...
            <label for="passverif">Password<span class="small">(verification)</span></label><input type="password" name="repassword" /><br />
            ...
            <input type="submit" value="Sign up" class="btn btn-large" disabled />
		</div>
    </form>
</div>
</div>
